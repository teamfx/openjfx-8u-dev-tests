...
public class TestLCDTextApp extends BasicButtonChooserApp {

    public static final String VISIBLE_CB = "visible";
    public static final String INITIAL_TEXT = "LCD Text";
    ...
    public TestLCDTextApp() {
        super(900, 750, "LCDTestText", false);
    }
    ...
    protected TestNode setup() {
        ...
        /*
                ...
                testText.setStyle("-fx-font-smoothing-type: lcd;");
        ...
        /*
                 addSlot("",testText);
                 UpdateRectangles();
                 addSlot("",localBoundsRect);
                 addSlot("",parentBoundsRect);
                 addSlot("",buttonList);
                 */
        ...
        root.add(page, "LCDTestText");
        this.selectNode(page);
        return root;
    }

    public static void main(String[] args) {
        test.javaclient.shared.Utils.launch(TestLCDTextApp.class, args);
    }
}
