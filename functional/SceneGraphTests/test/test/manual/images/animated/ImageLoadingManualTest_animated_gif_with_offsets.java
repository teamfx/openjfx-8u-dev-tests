 ...
 */
public class ImageLoadingManualTest_animated_gif_with_offsets {
    /*public static final String PATH_TO_FILE = "/test/scenegraph/resources/loading/manual/animated/animated_gif_with_offsets.gif";
