 ...
 */
public class ModalityZOrderAndFocusWithFileChooser2Test extends ModalityBase {
    ...
    public void case1Test() throws InterruptedException, Throwable {
        ...
        createSubstage("stage1", ModalityWindow.TestCase.NONE, true);
        createSubstage("stage2", ModalityWindow.TestCase.FILECH, true);
        ...
        Wrap<? extends Scene> sceneWrap = getSceneWrap("stage2");
        Parent<Node> parent = sceneWrap.as(Parent.class, Node.class);
        Wrap<? extends Label> labelWrap = Lookups.byID(parent, "stage2" + ModalityWindow.MOUSE_COUNTER_ID, Label.class);
