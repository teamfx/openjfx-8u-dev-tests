...
public class TranslucentPixelBeforeTextTest extends TransparencyLCDTestBase{


     @BeforeClass
     public static void runUI() {
         TransparencyLCDTextTestApp.testingFactory = Factories.TranslucentPixelBeforeText;
