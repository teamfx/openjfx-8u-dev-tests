...
public class TranslucentRectangleBeforeTextTest extends TransparencyLCDTestBase{


     @BeforeClass
     public static void runUI() {
         TransparencyLCDTextTestApp.testingFactory = Factories.TranslucentRectangleBeforeText;
