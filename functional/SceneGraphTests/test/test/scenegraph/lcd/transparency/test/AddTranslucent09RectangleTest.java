...
public class AddTranslucent09RectangleTest extends TransparencyLCDTestBase{


     @BeforeClass
     public static void runUI() {
         TransparencyLCDTextTestApp.testingFactory = Factories.AddTranslucent09Rectangle;
