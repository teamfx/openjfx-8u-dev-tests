...
public class SceneInputTest extends TestBase {
    ...
    public void SceneInputTest() throws InterruptedException {
        Wrap<? extends TextField> fldInput = Lookups.byID(getScene(), "inputfield", TextField.class);
    ...
    private void check() {
        Wrap<? extends Text> fldOutput = Lookups.byID(getScene(), "strOutput", Text.class);
