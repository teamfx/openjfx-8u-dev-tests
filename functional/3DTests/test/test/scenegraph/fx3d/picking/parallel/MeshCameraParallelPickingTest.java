 ...
 */
public class MeshCameraParallelPickingTest  extends MeshPickingTestBase {

    @BeforeClass
    public static void setUp() {
        MeshParallelPickingTestApp.main(null);
        app = mapp = (MeshParallelPickingTestApp) MeshParallelPickingTestApp.getInstance();
    }
