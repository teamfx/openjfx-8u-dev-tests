 ...
 */
public class ShapesCameraPerspectivePickingTest extends ShapesPickingTestBase {

    @BeforeClass
    public static void setUp() {
        ShapesPerspectivePickingTestApp.main(null);
        app = sapp = (ShapesPerspectivePickingTestApp) ShapesPerspectivePickingTestApp.getInstance();
    }
