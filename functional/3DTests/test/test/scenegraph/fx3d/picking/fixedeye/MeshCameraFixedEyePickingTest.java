 ...
 */
public class MeshCameraFixedEyePickingTest extends MeshPickingTestBase {

    @BeforeClass
    public static void setUp() {
        MeshFixedEyePickingTestApp.main(null);
        app = mapp = (MeshFixedEyePickingTestApp) MeshFixedEyePickingTestApp.getInstance();
    }
