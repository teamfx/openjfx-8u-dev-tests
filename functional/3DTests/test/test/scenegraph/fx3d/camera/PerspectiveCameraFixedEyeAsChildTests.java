 ...
 */
public abstract class PerspectiveCameraFixedEyeAsChildTests extends CameraAsChildTests implements PerspectiveCameraFixedEyeAsChildTestingFace {

    protected abstract PerspectiveCameraFixedEyeAsChildTestingFace getPerspectiveCameraFixedEyeAsChildTestingFace();

    @Override
    protected CameraAsChildTestingFace getCameraAsChildTestingFace() {
        return getPerspectiveCameraFixedEyeAsChildTestingFace();
    }
    ...
    public void setFieldOfView(final double d) {
        new GetAction() {
            ...
            public void run(Object... os) throws Exception {
                getPerspectiveCameraFixedEyeAsChildTestingFace().setFieldOfView(d);
            }
    ...
    public void setVerticalFieldOfView(final boolean bln) {
        new GetAction() {
            @Override
            public void run(Object... os) throws Exception {
                getPerspectiveCameraFixedEyeAsChildTestingFace().setVerticalFieldOfView(bln);
            }
        }.dispatch(Root.ROOT.getEnvironment());
    ...
    public boolean isVerticalFieldOfView() {
        return new GetAction<Boolean>() {
            @Override
            public void run(Object... os) throws Exception {
                setResult(getPerspectiveCameraFixedEyeAsChildTestingFace().isVerticalFieldOfView());
            }
        }.dispatch(Root.ROOT.getEnvironment());
