 ...
 */
public class SubScenePerspectiveCameraIsolateTest extends PerspectiveCameraIsolateTests {

    private static SubScenePerspectiveCameraIsolateTestApp app;
    ...
    @Override
    protected PerspectiveCameraIsolateTestingFace getPerspectiveCameraIsolateTestingFace() {
        return app;
    }
}