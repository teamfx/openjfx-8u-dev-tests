 ...
 */
public class SubSceneCylinderTest extends CylinderTests {

    private Pair<Integer, Integer>[] positions = null;
    private static SubSceneCylinderTestApp application;
    ...
    protected void setRadius(final double d) {
        new GetAction() {
            ...
            public void run(Object... os) throws Exception {
                ((SubSceneCylinderTestApp) application).setRadius(d);
            }
    ...
    protected void setHeight(final double d) {
        new GetAction() {
            @Override
            public void run(Object... os) throws Exception {
                ((SubSceneCylinderTestApp) application).setHeight(d);
            }
        }.dispatch(Root.ROOT.getEnvironment());
    }
    ...
    protected void setDivisions(final int d) {
        new GetAction() {
            @Override
            public void run(Object... os) throws Exception {
                ((SubSceneCylinderTestApp) application).setDivisions(d);
            }
        }.dispatch(Root.ROOT.getEnvironment());
    }
    ...
    protected int getDivisions() {
        return new GetAction<Integer>() {
            @Override
            public void run(Object... os) throws Exception {
                setResult(((SubSceneCylinderTestApp) application).getDivisions());
            }
        }.dispatch(Root.ROOT.getEnvironment());
    }
