 ...
 */
public abstract class SubSceneShapesPickingAbstractApp extends SubScenePickingAbstractApp{
    public void setShape(ShapesPickingAbstractApp.Shape shape) {
        ((ShapesPickingAbstractApp.ShapesPickingAbstractTestCase) ptc).setShape(shape);
    }
