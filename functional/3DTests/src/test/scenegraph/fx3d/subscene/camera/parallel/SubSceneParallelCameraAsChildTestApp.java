 ...
 */
public class SubSceneParallelCameraAsChildTestApp extends SubSceneCameraAsChildAbstractApp {
    ...
    public static void main(String[] args) {
        Utils.launch(SubSceneParallelCameraAsChildTestApp.class, args);
    }
}
