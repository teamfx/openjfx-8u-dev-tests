...
package com.sun.fx.webnode.tests.acid;
...
public class AcidTests {
    ...
    @RunUI(value="acid2.html")
    public static void acid2(){
        WebNodeLauncher.run("http://acid2.acidtests.org/#top");
    }
    @RunUI(value="acid3.html")
    public static void acid3(){
        WebNodeLauncher.run("http://acid3.acidtests.org/");
    }
}
