...
/**
 * In this test only the first toggle button is considered.
 *
 * @author Alexander Kirov
 */
@RunWith(FilteredTestRunner.class)
public class ToggleButtonEventsTest extends ToggleButtonTestBase {
    ...
    public void keyBoardEventsTest() throws InterruptedException, Exception {
        ...
        checkThreeStatesSimple(false, false, 2);
        ...
        checkThreeStatesSimple(false, true, 3);

        toggle2.keyboard().pushKey(KeyboardButtons.SPACE);
        checkThreeStatesSimple(false, false, 4);
