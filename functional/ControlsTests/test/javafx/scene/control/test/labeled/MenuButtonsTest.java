...
import javafx.scene.control.test.labeleds.MenuButtonsApp;
...
public class MenuButtonsTest extends ButtonsBase {

    //Util
    @BeforeClass
    public static void runUI() {
        MenuButtonsApp.main(null);
    }

    @Override
    protected String getName() {
        return "MenuButtonsTest";
    }
    ...
    protected String getEllipsingString() {
        ...
        if (null != lfProp) {
            if (0 == oldLookAndFeelName.compareTo(lfProp)) {
                return MenuButtonsApp.ELLIPSING_STRING;
            }
        }

        return MenuButtonsApp.ELLIPSING_STRING_MODENA;
    }
}