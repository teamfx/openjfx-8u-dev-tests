 ...
 */
public class FocusStyleKeyboardTest extends FocusKeyboardTestBase {
    ...
    **/
    @Test(timeout=20000)
    public void test_Toolbars() throws Exception {
        test(ControlsFactory.Toolbars.name());
    }
    ...
    **/
    @Test(timeout=20000)
    public void test_Accordions() throws Exception {
        test(ControlsFactory.Accordions.name());
    }
