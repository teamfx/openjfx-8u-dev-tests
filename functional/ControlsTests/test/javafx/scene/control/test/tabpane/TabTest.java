...
public class TabTest extends TestBase {
    ...
    public void closableTest() throws InterruptedException {
        testCommon(Pages.Closable.name(), null, true, false, TabApp.BOOL.length);
    }
    ...
    /**
     * Test for Tab setDisable API
     */
    @ScreenshotCheck
    @Test(timeout = 300000)
    public void disableTest() throws InterruptedException {
        testCommon(Pages.Disable.name(), null, true, false, TabApp.BOOL.length);
    }
}
