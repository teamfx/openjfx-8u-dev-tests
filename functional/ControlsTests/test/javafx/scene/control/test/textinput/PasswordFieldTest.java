...
public class PasswordFieldTest extends TextInputBase {

    //@RunUI
    @BeforeClass
    public static void runUI() {
        PasswordFieldApp.main(null);
    }

    /**
     * Test for TextField setPrefColumnCount API
     */
    //Test removed as replaced by test using property control.
    public void prefColumnCountTest() throws InterruptedException {
        testCommon(TextFieldApp.Pages.PrefColumnCount.name());
    }
