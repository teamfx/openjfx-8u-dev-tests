...
import javafx.scene.control.test.chart.apps.NewNumberScatterChartApp;
 ...
 */
public class NumberScatterChartTest extends XYChartsBase {

    @BeforeClass
    public static void setUpClass() {
        NewNumberScatterChartApp.main(null);
    }
