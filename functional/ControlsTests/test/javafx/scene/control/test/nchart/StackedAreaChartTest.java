...
import javafx.scene.control.test.chart.apps.NewStackedAreaChartApp;
 ...
 */
public class StackedAreaChartTest extends AreaStackedAreaChartsCommon {

    @BeforeClass
    public static void setUpClass() {
        NewStackedAreaChartApp.main(null);
    }
