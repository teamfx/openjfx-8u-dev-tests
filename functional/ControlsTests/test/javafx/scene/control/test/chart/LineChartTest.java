...
public class LineChartTest extends XYChartBase {

    //@RunUI
    @BeforeClass
    public static void runUI() {
        LineChartApp.main(null);
    }

    /**
     * Test for LineChart setCreateSymbols API
     */
    @ScreenshotCheck
    @Test(timeout = 300000)
    public void createSymbolsTest() throws InterruptedException {
        testCommon(Pages.CreateSymbols.name(), null, true, true, LineChartApp.BOOL.length);
    }
