...
public class BarChartApp extends XYChartBaseApp {

    public enum Pages {
        BarGap, CategoryGap
    }

    protected static final Double[] GAP_BAR = {0.0, 5.0, 15.0};

    public BarChartApp() {
        super("BarChart", false);
    }
    ...
    protected TestNode setup() {
        ...
        setupDouble(Pages.BarGap.name(), GAP_BAR);

        setupDouble(Pages.CategoryGap.name(), GAP_BAR);
    ...
    public static void main(String[] args) {
        Utils.launch(BarChartApp.class, args);
    }
}
