 ...
 */
public interface ChartIDsInterface {

    public final static String HARD_RESET_BUTTON_ID = "HARD_RESET_BARCHART_BUTTON_ID";
    public final static String SOFT_RESET_BUTTON_ID = "SOFT_RESET_BARCHART_BUTTON_ID";
    public final static String TESTED_CHART_ID = "TESTED_CHART_ID";
