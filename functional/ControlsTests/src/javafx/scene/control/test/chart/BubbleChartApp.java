...
public class BubbleChartApp extends XYChartBaseApp {

    public BubbleChartApp() {
        super("BubbleChart", false);
    }
    ...
    protected TestNode setup() {
        ...
        data.add(new Series("Additional Set 1", FXCollections.observableArrayList(
                    new XYChart.Data(2, 2, 0.5),
                    new XYChart.Data(3, 4, 0.2),
                    new XYChart.Data(6, 5, 2)
                )));
        data.add(new Series("Additional Set 2", FXCollections.observableArrayList(
                    new XYChart.Data(2, 5, 0.3),
                    new XYChart.Data(1, 5, 0.2),
                    new XYChart.Data(3, 3, 0.4)
                )));
        data.add(new Series("Additional Set 3", FXCollections.observableArrayList(
                    new XYChart.Data(6, 3, 0.2),
                    new XYChart.Data(2, 5, 1.2),
                    new XYChart.Data(2, 7, 1.1)
                )));
        ...
        series_data.add(new  XYChart.Data(1, 5, 0.5));
        series_data.add(new  XYChart.Data(2, 2, 0.2));
        series_data.add(new  XYChart.Data(3, 7, 2));
    ...
    @Override
    protected Chart createObject(Axis x_axis, Axis y_axis) {
    ...
    public static void main(String[] args) {
        Utils.launch(BubbleChartApp.class, args);
    }
}
