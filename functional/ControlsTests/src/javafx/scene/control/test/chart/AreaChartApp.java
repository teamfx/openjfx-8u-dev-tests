...
public class AreaChartApp extends XYChartBaseApp {
    ...
    protected TestNode setup() {
        ...
        data.add(new Series("Additional Set 3", FXCollections.observableArrayList(
                    new XYChart.Data(8,7),
                    new XYChart.Data(9,1),
                    new XYChart.Data(10,2)
                )));
        ...
        series_data.add(new XYChart.Data(7.5,2));
    ...
    public static void main(String[] args) {
        Utils.launch(AreaChartApp.class, args);
    }
}