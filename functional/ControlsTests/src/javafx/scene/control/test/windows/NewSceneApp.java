 ...
 */
public class NewSceneApp extends InteroperabilityApp {

    public static void main(String[] args) {
        Utils.launch(NewSceneApp.class, args);
    }
    ...
    class SimpleScene extends Scene {
        ...
        private void prepareScene() {
            ...
            PropertiesTable tb = new PropertiesTable(this);
            PropertyTablesFactory.explorePropertiesList(this, tb);
