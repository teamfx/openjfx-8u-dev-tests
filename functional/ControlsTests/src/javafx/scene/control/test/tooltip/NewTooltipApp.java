 ...
 * questions.
 */
package javafx.scene.control.test.Tooltip;
 ...
 */
public class NewTooltipApp extends InteroperabilityApp {

    public final static String TESTED_TOOLTIP_ID = "TESTED_TOOLTIP_ID";
    public final static String RESET_BUTTON_ID = "RESET_Tooltip_BUTTON_ID";

    public static void main(String[] args) {
        Utils.launch(NewTooltipApp.class, args);
    }

    @Override
    protected Scene getScene() {
        Utils.setTitleToStage(stage, "TooltipTestApp");
        return new NewTooltipApp.TooltipScene();
    }

    class TooltipScene extends CommonPropertiesScene {

        //VBox which contain tested tooltip.
        Pane pane;
        PropertiesTable tb;
        //Tooltip to be tested.
        Tooltip testedTooltip;

        public TooltipScene() {
            super("Tooltip", 800, 600);
        ...
        final protected void prepareScene() {
            ...
            Button button = new Button("Tooltip attached.");
            button.setTooltip(testedTooltip);
