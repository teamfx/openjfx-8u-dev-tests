...
public class BooleanPropertyValueSetter extends AbstractPropertyValueSetter<Boolean> {
    ...
    public BooleanPropertyValueSetter(Property listeningProperty, BindingType btype, Object testedControl) {
        try {
            tb.setId(createId(listeningProperty, btype));
            tb.textProperty().bind(tb.selectedProperty().asString());
            this.leadingControl = tb;
            this.listeningProperty = listeningProperty;
            this.leadingProperty = (Property) tb.selectedProperty();
    ...
    public void refresh() {
        ...
        leadingProperty.setValue(initialValue1);
    }
