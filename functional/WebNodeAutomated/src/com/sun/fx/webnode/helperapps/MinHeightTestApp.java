 ...
 */
public class MinHeightTestApp extends Application {

    public static final double MIN_HEIGHT = 108.;
    public static final String VIEW_ID = "MinHeightTestView";
    ...
    public static void main(String []args) {
        test.javaclient.shared.Utils.launch(MinHeightTestApp.class, args);
    }
}
