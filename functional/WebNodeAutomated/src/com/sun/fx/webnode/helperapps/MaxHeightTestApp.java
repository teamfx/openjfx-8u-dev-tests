 ...
 */
public class MaxHeightTestApp extends Application {

    public static final double MAX_HEIGHT = 99.;
    public static final String VIEW_ID = "MaxHeightTestView";
    ...
    public static void main(String []args) {
        test.javaclient.shared.Utils.launch(MaxHeightTestApp.class, args);
    }
}
