 ...
 */
public class MaxWidthTestApp extends Application {

    public static final double MAX_WIDTH = 141.;
    public static final String VIEW_ID = "MaxWidthTestView";
    ...
    public static void main(String []args) {
        test.javaclient.shared.Utils.launch(MaxWidthTestApp.class, args);
    }
}
