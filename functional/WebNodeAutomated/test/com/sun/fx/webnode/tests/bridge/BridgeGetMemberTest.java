...
/**
 * Tests for JSObject.getMember.
 * @author Irina Latysheva
 */
public class BridgeGetMemberTest extends BridgeTestClass {
    ...
    /**
     * Test for simple JSObject.getMember call.
     */
    @Test(timeout=10000)
    public void testGetMember(){
        Platform.runLater(new Runnable() {
            public void run() {
                ...
                resultObject = stringO.getMember("length");
    ...
    /**
     * Test for JSObject.getMember call on an absent member.
     */
    @Test(timeout=10000)
    public void testGetMemberNoSuchMember(){
        Platform.runLater(new Runnable() {
            public void run() {
                initWebEngine();
                JSObject stringO = getString(engine);
                resultObject = stringO.getMember("wrongMember");
                System.out.println(resultObject);
            }
        });
        doWait(new Tester() {
