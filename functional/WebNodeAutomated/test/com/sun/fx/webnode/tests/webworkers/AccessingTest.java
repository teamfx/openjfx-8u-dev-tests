...
/**
 * Tests for accessing Document/Window/Parent objects from a worker.
 * @author Irina Grineva
 */
public class AccessingTest extends WorkerTestClass {
    @BeforeClass
    ...
    public void accessWindow() {
        ...
        Platform.runLater(new Runnable() {
            public void run() {
                engine.load(getAbsolutePathToResource("resources/windowAccessingPage.html"));
            }
        });
        doWaitPageLoading();
        waitForResult("true");
    ...
    public void accessParent() {
        ...
        Platform.runLater(new Runnable() {
            public void run() {
                engine.load(getAbsolutePathToResource("resources/parentAccessingPage.html"));
            }
        });
        doWaitPageLoading();
        waitForResult("true");
