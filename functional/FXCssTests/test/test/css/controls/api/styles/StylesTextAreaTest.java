 ...
 */
public class StylesTextAreaTest extends BaseStyleNodeTest {
    ...
    public void testfxdisplaycaret () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-display-caret"));
        Map<String, CssMetaData> styles = getStyles();
    ...
    public void testfxhighlightfill () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-highlight-fill"));
        Map<String, CssMetaData> styles = getStyles();
    ...
    public void testfxhighlighttextfill () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-highlight-text-fill"));
        Map<String, CssMetaData> styles = getStyles();
    ...
    public void testfxprefcolumncount () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-pref-column-count"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-pref-column-count");
        Assert.assertEquals(data.getInitialValue(getControl()), 40);
    }

    @Test
    public void testfxprefrowcount () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-pref-row-count"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-pref-row-count");
    ...
    public void testfxprompttextfill () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-prompt-text-fill"));
        Map<String, CssMetaData> styles = getStyles();
