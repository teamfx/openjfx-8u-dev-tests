 ...
 */
public class StylesFlowPaneTest extends BaseStyleNodeTest {
    ...
    @Test
    public void testfxcolumnhalignment () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-column-halignment"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-column-halignment");
        Assert.assertEquals(data.getInitialValue(getControl()), javafx.geometry.HPos.LEFT);
    }
    ...
    @Test
    public void testfxrowvalignment () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-row-valignment"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-row-valignment");
        Assert.assertEquals(data.getInitialValue(getControl()), javafx.geometry.VPos.CENTER);
    }
