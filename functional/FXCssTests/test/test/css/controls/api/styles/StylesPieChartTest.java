 ...
 */
public class StylesPieChartTest extends BaseStyleNodeTest {
    ...
    public void testfxclockwise () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-clockwise"));
        Map<String, CssMetaData> styles = getStyles();
    ...
    public void testfxlabellinelength () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-label-line-length"));
        Map<String, CssMetaData> styles = getStyles();
    ...
    public void testfxlegendside () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-legend-side"));
        Map<String, CssMetaData> styles = getStyles();
    ...
    public void testfxlegendvisible () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-legend-visible"));
        Map<String, CssMetaData> styles = getStyles();
    ...
    public void testfxpielabelvisible () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-pie-label-visible"));
        Map<String, CssMetaData> styles = getStyles();
    ...
    public void testfxstartangle () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-start-angle"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-start-angle");
        Assert.assertEquals(data.getInitialValue(getControl()), 0.0);
    }

    @Test
    public void testfxtitleside () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-title-side"));
        Map<String, CssMetaData> styles = getStyles();
