 ...
 */
public class StylesTitledPaneTest extends BaseStyleNodeTest {
    ...
    @Test
    public void testfxanimated () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-animated"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-animated");
    ...
    @Test
    public void testfxcollapsible () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-collapsible"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-collapsible");
        Assert.assertEquals(data.getInitialValue(getControl()), true);
    }
