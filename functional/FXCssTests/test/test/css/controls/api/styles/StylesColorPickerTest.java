 ...
 */
public class StylesColorPickerTest extends BaseStyleNodeTest {
    ...
    Node getControl() {
        return new GetAction<Node>() {
            ...
            public void run(Object... os) throws Exception {
                ColorPicker control = new ColorPicker();
    ...
    @Test
    public void testfxcolorlabelvisible () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-color-label-visible"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-color-label-visible");
