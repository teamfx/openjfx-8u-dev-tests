 ...
 */
public class StylesTableViewTest extends BaseStyleNodeTest {
    ...
    @Test
    public void testfxfixedcellsize () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-fixed-cell-size"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-fixed-cell-size");
