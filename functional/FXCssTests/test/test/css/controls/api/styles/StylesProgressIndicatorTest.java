 ...
 */
public class StylesProgressIndicatorTest extends BaseStyleNodeTest {
    ...
    Node getControl() {
        return new GetAction<Node>() {
            ...
            public void run(Object... os) throws Exception {
                ProgressIndicator control = new ProgressIndicator();
    ...
    @Test
    public void testfxprogresscolor () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-progress-color"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-progress-color");
        Assert.assertEquals(data.getInitialValue(getControl()), null);
    }
