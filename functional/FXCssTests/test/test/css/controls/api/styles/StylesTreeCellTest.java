 ...
 */
public class StylesTreeCellTest extends BaseStyleNodeTest {
    ...
    @Test
    public void testfxindent () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-indent"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-indent");
