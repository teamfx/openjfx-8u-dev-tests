 ...
 */
public class StylesSliderTest extends BaseStyleNodeTest {
    ...
    public void testfxblockincrement () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-block-increment"));
        Map<String, CssMetaData> styles = getStyles();
    ...
    public void testfxmajortickunit () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-major-tick-unit"));
        Map<String, CssMetaData> styles = getStyles();
    ...
    public void testfxshowticklabels () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-show-tick-labels"));
        Map<String, CssMetaData> styles = getStyles();
    ...
    public void testfxshowtickmarks () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-show-tick-marks"));
        Map<String, CssMetaData> styles = getStyles();
    ...
    public void testfxsnaptoticks () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-snap-to-ticks"));
        Map<String, CssMetaData> styles = getStyles();
