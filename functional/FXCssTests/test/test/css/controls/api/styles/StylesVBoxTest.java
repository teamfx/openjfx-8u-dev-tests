 ...
 */
public class StylesVBoxTest extends BaseStyleNodeTest {
    ...
    @Test
    public void testfxfillwidth () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-fill-width"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-fill-width");
