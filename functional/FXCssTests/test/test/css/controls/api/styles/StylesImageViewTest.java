 ...
 */
public class StylesImageViewTest extends BaseStyleNodeTest {
    ...
    @Test
    public void testfximage () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-image"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-image");
        Assert.assertEquals(data.getInitialValue(getControl()), null);
    }
