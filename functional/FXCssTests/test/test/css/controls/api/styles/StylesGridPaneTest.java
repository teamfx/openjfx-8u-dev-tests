 ...
 */
public class StylesGridPaneTest extends BaseStyleNodeTest {
    ...
    @Test
    public void testfxgridlinesvisible () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-grid-lines-visible"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-grid-lines-visible");
