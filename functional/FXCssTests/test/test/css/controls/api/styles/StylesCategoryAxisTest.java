 ...
 */
public class StylesCategoryAxisTest extends BaseStyleNodeTest {
    ...
    Node getControl() {
        return new GetAction<Node>() {
            ...
            public void run(Object... os) throws Exception {
                CategoryAxis control = new CategoryAxis();
                setResult(control);
            }
    ...
    @Test
    public void testfxendmargin () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-end-margin"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-end-margin");
        Assert.assertEquals(data.getInitialValue(getControl()), 5.0);
    }

    @Test
    public void testfxgapstartandend () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-gap-start-and-end"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-gap-start-and-end");
    ...
    @Test
    public void testfxstartmargin () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-start-margin"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-start-margin");
        Assert.assertEquals(data.getInitialValue(getControl()), 5.0);
    }
