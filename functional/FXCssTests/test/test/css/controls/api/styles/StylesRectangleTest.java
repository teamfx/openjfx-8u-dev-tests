 ...
 */
public class StylesRectangleTest extends BaseStyleNodeTest {
    ...
    @Test
    public void testfxarcheight () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-arc-height"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-arc-height");
        Assert.assertEquals(data.getInitialValue(getControl()), 0.0);
    }

    @Test
    public void testfxarcwidth () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-arc-width"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-arc-width");
        Assert.assertEquals(data.getInitialValue(getControl()), 0.0);
    }
