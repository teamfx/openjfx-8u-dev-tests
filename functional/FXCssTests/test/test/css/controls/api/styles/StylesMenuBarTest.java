 ...
 */
public class StylesMenuBarTest extends BaseStyleNodeTest {
    ...
    @Test
    public void testfxusesystemmenubar () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-use-system-menu-bar"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-use-system-menu-bar");
