 ...
 */
public class StylesScrollPaneTest extends BaseStyleNodeTest {
    ...
    Node getControl() {
        return new GetAction<Node>() {
            ...
            public void run(Object... os) throws Exception {
                ScrollPane control = new ScrollPane();
    ...
    @Test
    public void testfxfittoheight () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-fit-to-height"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-fit-to-height");
        Assert.assertEquals(data.getInitialValue(getControl()), false);
    }

    @Test
    public void testfxfittowidth () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-fit-to-width"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-fit-to-width");
        Assert.assertEquals(data.getInitialValue(getControl()), false);
    }

    @Test
    public void testfxhbarpolicy () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-hbar-policy"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-hbar-policy");
        Assert.assertEquals(data.getInitialValue(getControl()).toString(), "AS_NEEDED");
    }
    ...
    @Test
    public void testfxpannable () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-pannable"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-pannable");
        Assert.assertEquals(data.getInitialValue(getControl()), false);
    }
    ...
    @Test
    public void testfxvbarpolicy () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-vbar-policy"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-vbar-policy");
        Assert.assertEquals(data.getInitialValue(getControl()).toString(), "AS_NEEDED");
    }
