 ...
 */
public class StylesHBoxTest extends BaseStyleNodeTest {
    ...
    @Test
    public void testfxfillheight () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-fill-height"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-fill-height");
    ...
    @Test
    public void testfxspacing () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-spacing"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-spacing");
        Assert.assertEquals(data.getInitialValue(getControl()), 0.0);
    }
