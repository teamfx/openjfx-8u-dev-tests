 ...
 */
public class StylesTabPaneTest extends BaseStyleNodeTest {
    ...
    @Test
    public void testfxclosetabanimation () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-close-tab-animation"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-close-tab-animation");
        Assert.assertEquals(data.getInitialValue(getControl()).toString(), "GROW");
    }
    ...
    @Test
    public void testfxopentabanimation () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-open-tab-animation"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-open-tab-animation");
        Assert.assertEquals(data.getInitialValue(getControl()).toString(), "GROW");
    }
    ...
    @Test
    public void testfxtabmaxheight () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-tab-max-height"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-tab-max-height");
        Assert.assertEquals(data.getInitialValue(getControl()), Double.MAX_VALUE);
    }

    @Test
    public void testfxtabmaxwidth () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-tab-max-width"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-tab-max-width");
        Assert.assertEquals(data.getInitialValue(getControl()), Double.MAX_VALUE);
    }

    @Test
    public void testfxtabminheight () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-tab-min-height"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-tab-min-height");
        Assert.assertEquals(data.getInitialValue(getControl()), 0.0);
    }

    @Test
    public void testfxtabminwidth () {
        Set<String> styleNames = getStyleNames();
        Assert.assertNotNull(styleNames);
        Assert.assertTrue(styleNames.contains("-fx-tab-min-width"));
        Map<String, CssMetaData> styles = getStyles();
        CssMetaData data = styles.get("-fx-tab-min-width");
        Assert.assertEquals(data.getInitialValue(getControl()), 0.0);
    }
