...
/**
 * Settings legend style, for left and right need set minimum width if we have see
 * @author Sergey Lugovoy <sergey.lugovoy@oracle.com>
 */
public class LegendSideAlignmentCssStyle extends SideAlignmentCssStyle {

    private Side side;

    public LegendSideAlignmentCssStyle(String name, String style, Side side) {
        super(name, style);
        this.side = side;
    }
