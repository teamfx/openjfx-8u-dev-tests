...
@DockInfo(name = "org.jemmy.fx.control.TreeTableCellItemDock", generateSubtypeLookups = true, multipleCriteria = false)
public class TreeTableCellItemWrap<DATA extends Object> extends ItemWrap<DATA> implements Showable {
    ...
    public TreeTableCellItemWrap(TreeTableViewWrap<? extends TreeTableView> treeTableViewWrap, int row, TreeTableColumn column, DATA cellItem, CellEditor<? super DATA> editor) {
        this(treeTableViewWrap, null, row, column, cellItem, editor);
    }

    public TreeTableCellItemWrap(TreeTableViewWrap<? extends TreeTableView> treeTableViewWrap, Class<DATA> dataClass, int row, TreeTableColumn column, DATA cellItem, CellEditor<? super DATA> editor) {
