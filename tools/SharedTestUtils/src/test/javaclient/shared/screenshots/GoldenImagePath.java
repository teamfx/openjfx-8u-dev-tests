...
public class GoldenImagePath {
    ...
    public static String getGoldenImagePath(final String _baseDir,
        ...
        boolean bLFeelDefinedAsCaspian = false;
        final String lfProp = System.getProperty("javafx.userAgentStylesheetUrl");
        if (null != lfProp) {
            if (0 == oldLookAndFeelName.compareTo(lfProp)) {
                bLFeelDefinedAsCaspian = true;
            }
        }

        String result = _baseDir + File.separator + ".." + File.separator + _ROOT_IMAGES_DIRECTORY + File.separator;
        if (true == bLFeelDefinedAsCaspian) {
