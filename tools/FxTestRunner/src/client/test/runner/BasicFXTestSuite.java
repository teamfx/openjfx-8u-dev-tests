 ...
 * @author sg
 */
public class BasicFXTestSuite extends TestSuite {

    /**
     *
     * @param root
     */
    public BasicFXTestSuite(File root) {
        super(root);
    }
     ...
     * @throws Fault
     */
    public BasicFXTestSuite(File root, Map tsInfo, ClassLoader cl) throws Fault {
    ...
    public Script createScript(TestDescription td, String[] exclTestCases, TestEnvironment scriptEnv,
        ...
        if (td.getKeywordTable().contains("media")) {
            throw new RuntimeException("FixMe: was: s = new MediaTestScript();");
